data = [
	...
	const list_element = document.getElementById('tdata');
	...
	console.log(pagination_element);

	function DisplayList (items, rows_per_page=5, page=1) 
	{
		page--;
    ...
    newButton.setAttribute("onclick","changePage("+i+")");
    newButton.setAttribute("class","btn btn-primary")
		div1.appendChild(newButton);
	}

	document.getElementById("pagination").appendChild(div1);
